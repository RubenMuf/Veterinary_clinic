from django.contrib.auth.views import LogoutView, AuthenticationForm, PasswordChangeDoneView, PasswordResetView, \
...
urlpatterns = [
    ...
    path('register_done/', views.register_done, name='register_done'), # для открытия страницы с сообщением что вы успешно зарегистрировались и в ней ссылочка на профиль
]